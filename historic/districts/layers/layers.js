...
lyr_StJosephHistoricDistricts_3.set('fieldImages', {'fid': 'TextEdit', 'HST_NAME': 'TextEdit', 'OTHR_NAME': 'TextEdit', 'MPS_MRA': 'TextEdit', 'COMMENT_': 'TextEdit', 'PERIOD_SIG': 'TextEdit', 'ARCHITECT': 'TextEdit', 'PADDRESS': 'TextEdit', 'PLOCALNAME': 'TextEdit', 'DATE_LIST': 'DateTime', 'narrative': 'TextEdit', });
...
lyr_StJosephHistoricDistricts_3.set('fieldLabels', {'fid': 'hidden field', 'HST_NAME': 'no label', 'OTHR_NAME': 'hidden field', 'MPS_MRA': 'hidden field', 'COMMENT_': 'hidden field', 'PERIOD_SIG': 'hidden field', 'ARCHITECT': 'hidden field', 'PADDRESS': 'no label', 'PLOCALNAME': 'hidden field', 'DATE_LIST': 'no label', 'narrative': 'hidden field', });
